...
./build/tools/caffe train -solver=models/mollahosseini_fer/train_val2_bottom_solver.prototxt -snapshot=models/mollahosseini_fer/snapshots/blurring_bottom_iter_640000.solverstate -gpu=2
# ./build/tools/caffe train -solver=models/mollahosseini_fer/train_val2_bottom_solver.prototxt -snapshot=models/mollahosseini_fer/snapshots/blurring_bottom_iter_320000.solverstate -gpu=2
