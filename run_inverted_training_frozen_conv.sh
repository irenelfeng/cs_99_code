cd ~/cs99/caffe
./build/tools/caffe train -solver=models/mollahosseini_fer/inverted_frozen_solver.prototxt -weights=models/mollahosseini_fer/training_snapshot_googlenet_quick_iter_100000.caffemodel
