...
./build/tools/caffe train -solver=models/mollahosseini_fer/from_googlenet_solver.prototxt -snapshot=models/mollahosseini_fer/snapshots/_iter_560000.solverstate -gpu 1
